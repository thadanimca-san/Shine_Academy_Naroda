...
/// been placed on disk; falls back to a text-only banner otherwise so the
/// app never breaks while the asset is pending. Tapping it opens the
/// academy's website — a low-friction way to expose the link on every
/// screen this header appears on, without adding dedicated UI for it.
