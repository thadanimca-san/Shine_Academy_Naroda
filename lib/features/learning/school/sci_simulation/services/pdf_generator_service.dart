...
class PdfGeneratorService {
  ...
  static Future<void> _generatePdf(List<ChapterModel> chapters, {required bool isAnswerKey}) async {
          ...
          List<pw.Widget> content = [
            ...
            pw.Text(
              isAnswerKey
                  ...
                  : 'Instructions: Fill in the blanks with appropriate scientific terms.',
    ...
    final standard = chapters.isNotEmpty ? chapters.first.standard.toString() : '';
    final baseName = chapters.length == 1
        ? '${chapters.first.chapterId}_Class$standard'
        : 'Class${standard}_MultiChapter';
    await Printing.sharePdf(
      bytes: bytes,
      filename: isAnswerKey ? '${baseName}_Answer_Key.pdf' : '${baseName}_Question_Paper.pdf',
    );
  }
}