              ...
              child: Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Icon(Icons.lock_outline, size: 48, color: Color(0xFF0D2A4A)),
                      const SizedBox(height: 12),
                      Text(TrilingualService.instance.getUIText('Activate Your App'),
                        textAlign: TextAlign.center,
                        style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFF0D2A4A)),
                      ),
                      ...
                      Text(TrilingualService.instance.getUIText('Your Device Code'), style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Theme.of(context).colorScheme.onSurfaceVariant)),
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            IconButton(
                              icon: Icon(Icons.copy, color: Color(0xFF8A6100)),
                      ...
                      const SizedBox(height: 20),
                      Text(TrilingualService.instance.getUIText('Enter Your Unlock Code'), style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Theme.of(context).colorScheme.onSurfaceVariant)),
                      const SizedBox(height: 6),
                      TextField(
